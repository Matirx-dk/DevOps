package com.aidevops.gateway.config;
...
class SwaggerDocRegister extends Subscriber<InstancesChangeEvent>
{
    ...
    private final static String[] EXCLUDE_ROUTES = new String[] { "aidevops-gateway", "aidevops-auth", "aidevops-file", "aidevops-monitor" };
