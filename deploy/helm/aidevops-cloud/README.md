...
- `harbor.zoudekang.cloud/dockerhub-proxy/library/busybox:1.36`
...
- 正确：`harbor.zoudekang.cloud/dockerhub-proxy/library/mysql:8.0`
- 正确：`harbor.zoudekang.cloud/dockerhub-proxy/library/redis:7-alpine`
- 错误：`harbor.zoudekang.cloud/dockerhub-proxy/mysql:8.0`
...
```bash
ctr -n k8s.io images pull --plain-http harbor.zoudekang.cloud/dockerhub-proxy/library/mysql:8.0
ctr -n k8s.io images pull --plain-http harbor.zoudekang.cloud/dockerhub-proxy/library/redis:7-alpine
ctr -n k8s.io images pull --plain-http harbor.zoudekang.cloud/dockerhub-proxy/nacos/nacos-server:v2.2.3
```
...
- `harbor.zoudekang.cloud/aidevops/...`
