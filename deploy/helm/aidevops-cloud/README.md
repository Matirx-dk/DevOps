...
- `192.168.1.100:3443/dockerhub-proxy/library/busybox:1.36`
...
- 正确：`192.168.1.100:3443/dockerhub-proxy/library/mysql:8.0`
- 正确：`192.168.1.100:3443/dockerhub-proxy/library/redis:7-alpine`
- 错误：`192.168.1.100:3443/dockerhub-proxy/mysql:8.0`
...
```bash
ctr -n k8s.io images pull --plain-http 192.168.1.100:3443/dockerhub-proxy/library/mysql:8.0
ctr -n k8s.io images pull --plain-http 192.168.1.100:3443/dockerhub-proxy/library/redis:7-alpine
ctr -n k8s.io images pull --plain-http 192.168.1.100:3443/dockerhub-proxy/nacos/nacos-server:v2.2.3
```
